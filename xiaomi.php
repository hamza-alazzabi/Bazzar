...
-->
      ...
      <div class="col-sm">
      <div class="thumbnail">
      <img src="xiaomi\index-1.jpg" width="85%" alt="My desktop" class="rounded mx-auto d-block">
      </div>
      </div>
      </div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm">
            <div class="img-thumbnail text-center">
              <a href="" target="_self">
            <img src="xiaomi\xiaomi-redmi-note-7.jpg" alt="My desktop"></a>
        ...
        <div class="col-sm">
            <div class="img-thumbnail text-center">
              <a href="#" target="_self">
            <img src="xiaomi\xiaomi-miplay.jpg" alt="My desktop">
            </a>
            <div class="caption text-center">
                <h5>Mi Play</h5>
                <p>
        ...
        <div class="col-sm">
            <div class="img-thumbnail text-center">
            <img src="xiaomi\xiaomi-black-shark2.jpg" alt="My desktop">
            <div class="caption text-center">
                <h5>Black Shark 2</h5>
                <p>
                   Black <br>
        ...
        <div class="col-sm">
            <div class="img-thumbnail text-center">
            <img src="xiaomi\xiaomi-mi-mix3.jpg" alt="My desktop">
            <div class="caption text-center">
                <h5>Mi Mix3</h5>
                <p>
                   Midnight Blue <br>
        ...
        <div class="col-sm">
         <div class="img-thumbnail text-center">
         <img src="xiaomi\xiaomi-pocophone-f1-.jpg" alt="My desktop">
         <div class="caption text-center">
             <h5>Pocophone F1</h5>
             <p>
                Red <br>
     ...
     <div class="col-sm">
      <div class="img-thumbnail text-center">
      <img src="xiaomi\xiaomi-mi8-explore-.jpg" alt="My desktop">
      <div class="caption text-center">
          <h5>Mi 8 Explore</h5>
          <p>
              Black   <br>
  ...
  <div class="col-sm">
   <div class="img-thumbnail text-center">
   <img src="xiaomi\xiaomi-redmi-note-6-pro-r.jpg" alt="My desktop">
   <div class="caption text-center">
       <h5>redmi Note 6 Pro R</h5>
       <p>
          Rose Gold <br>
           by Xiaomi <br>
...
<div class="col-sm">
 <div class="img-thumbnail text-center">
 <img src="xiaomi\xiaomi-mi-mix2-new.jpg" alt="My desktop">
 <div class="caption text-center">
     <h5>Mi Mix2</h5>
     <p>
         Blue <br>
